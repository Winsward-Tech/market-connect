...
import { Users, MessageCircle, Search, ThumbsUp, MessageSquare, ArrowLeft, VolumeIcon as VolumeUp } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-blue-50">
      ...
      <div className="container mx-auto py-8 px-4">
        <h1 className="text-3xl font-bold text-blue-800 mb-6">Community Forum</h1>

        <p className="text-lg mb-8">
          Connect with other farmers and market women to share knowledge, ask questions, and build relationships.
        </p>

        <div className="flex items-center mb-8 relative">
          <Input placeholder="Search discussions..." className="pl-10 py-6 text-lg" />
        ...
        <div className="mb-8 bg-blue-50 rounded-xl p-6">
          <h2 className="text-xl font-bold text-blue-800 mb-4">Featured Community Members</h2>
...
function DiscussionCard({ title, author, authorRole, date, content, replies, likes, category }) {
    ...
    <Card className="overflow-hidden transition-all hover:shadow-md border-l-4 hover:border-l-8 border-l-blue-500 group">
      <CardHeader>
        <div className="flex justify-between items-start">
          <div>
            <CardTitle className="text-xl mb-1 group-hover:text-blue-600 transition-colors">{title}</CardTitle>
            <div className="flex items-center text-sm text-gray-500">
              <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center mr-2 text-xs text-blue-700 font-bold">
                {author.charAt(0)}
              </div>
          ...
          <span className={`text-xs font-medium px-2 py-1 rounded-full flex items-center ${getCategoryColor()}`}>
            {getCategoryIcon()}
            {category}
          </span>
        </div>
      ...
      <CardFooter className="flex justify-between border-t pt-4 bg-gray-50">
        <div className="flex items-center space-x-4">
          <Button
            variant="ghost"
            size="sm"
            className="flex items-center text-gray-700 hover:text-blue-600 hover:bg-blue-50"
          >
