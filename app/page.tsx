...
import { ChevronRight, BookOpen, Users, ShoppingBag, Globe, VolumeIcon as VolumeUp } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-yellow-50">
      ...
      <section className="py-8 px-4 text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-green-800 mb-4">Welcome to Market Connect</h1>
      ...
      <section className="py-12 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold text-center text-green-800 mb-8">Our Platform Features</h2>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-center text-green-800 mb-8">How Market Connect Works</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <StepCard
              number="1"
      ...
      <section className="py-12 px-4 bg-green-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-center text-green-800 mb-8">Success Stories</h2>
      ...
      <footer className="bg-green-800 text-white py-8 px-4">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p>Empowering Ghanaian market women and farmers through education, community, and market access.</p>
          </div>
          <div>
...
function FeatureCard({ icon, title, description, href, color }) {
  return (
    <Link href={href}>
      ...
      >
        <div className="flex justify-center mb-4 bg-white p-4 rounded-full shadow-sm">{icon}</div>
