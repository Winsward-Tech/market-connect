        ...
        <Tabs defaultValue="business" className="mb-8">
          ...
          <TabsContent value="business">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <LearningCard title="Financial Literacy Basics" description="Learn how to manage your money, save, and plan for your business" type="video" level="Beginner" duration="20 min"/>
              <LearningCard title="Pricing Your Products" description="How to set the right prices for your goods to maximize profit" type="audio" level="Beginner" duration="15 min"/>
              <LearningCard title="Record Keeping" description="Simple methods to track your sales, expenses, and inventory" type="guide" level="Intermediate" duration="25 min"/>
              <LearningCard title="Digital Marketing Basics" description="How to promote your business using mobile phones and social media" type="video" level="Beginner" duration="30 min"/>
              <LearningCard title="Expanding Your Market" description="Strategies to find new customers and enter new markets" type="guide" level="Intermediate" duration="20 min"/>
              <LearningCard title="Mobile Money for Business" description="How to use mobile money services safely for your business" type="video" level="Beginner" duration="15 min"/>
            </div>
          </TabsContent>

          <TabsContent value="farming">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <LearningCard title="Sustainable Farming Practices" description="Learn eco-friendly farming techniques that improve yield" type="video" level="Beginner" duration="25 min"/>
              <LearningCard title="Crop Rotation Basics" description="How to plan crop rotation to maintain soil health" type="guide" level="Intermediate" duration="20 min"/>
              <LearningCard title="Pest Management" description="Natural methods to control pests and protect your crops" type="video" level="Beginner" duration="30 min"/>
              <LearningCard title="Water Conservation" description="Techniques to reduce water usage while maintaining crop health" type="audio" level="Beginner" duration="15 min"/>
              <LearningCard title="Post-Harvest Handling" description="How to store and preserve your harvest to reduce losses" type="guide" level="Intermediate" duration="25 min"/>
              <LearningCard title="Organic Fertilizers" description="How to make and use organic fertilizers for better crops" type="video" level="Beginner" duration="20 min"/>
            </div>
          </TabsContent>

          <TabsContent value="health">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <LearningCard title="Workplace Safety" description="How to stay safe and healthy while working at the market or farm" type="video" level="Beginner" duration="20 min"/>
              <LearningCard title="Nutrition Basics" description="Understanding balanced diets and healthy eating habits" type="guide" level="Beginner" duration="15 min"/>
              <LearningCard title="Heat Stress Prevention" description="How to protect yourself from heat-related illnesses while working" type="audio" level="Beginner" duration="10 min"/>
              <LearningCard title="First Aid Essentials" description="Basic first aid skills for common injuries at work" type="video" level="Intermediate" duration="30 min"/>
              <LearningCard title="Mental Health Awareness" description="Understanding stress and maintaining mental wellbeing" type="guide" level="Beginner" duration="20 min"/>
              <LearningCard title="Safe Food Handling" description="Proper techniques for handling and storing food products" type="video" level="Beginner" duration="15 min"/>
            </div>
          </TabsContent>
        </Tabs>
...
function LearningCard(_a) {
    var title = _a.title, description = _a.description, type = _a.type, level = _a.level, duration = _a.duration;
    ...
    var getTypeBackground = function () {
        switch (type) {
            case "video":
    ...
    return (<Card className="overflow-hidden transition-all hover:shadow-lg group">
      <div className={"h-40 bg-gradient-to-r ".concat(getTypeBackground(), " flex items-center justify-center relative")}>
        <div className="absolute inset-0 bg-white/0 group-hover:bg-white/10 transition-all"></div>
        <div className="bg-white rounded-full p-4 shadow-md">{getTypeIcon()}</div>
        {type === "video" && (<div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
            <div className="w-14 h-14 rounded-full bg-white/80 flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 text-red-500 ml-1">
      ...
      <CardHeader>
        <div className="flex justify-between items-center mb-2">
          <span className={"text-xs font-medium px-2 py-1 rounded-full ".concat(getTypeColor())}>{type.toUpperCase()}</span>
          <div className="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 text-gray-500 mr-1">
